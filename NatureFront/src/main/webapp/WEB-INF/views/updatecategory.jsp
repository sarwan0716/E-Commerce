...
<div class="container">
    <%-- <form class="form-horizontal" action="<c:url value="/admin/UpdateCategory"/>" method="post"> --%>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" readonly id="catid" name="catid" value="${categoryInfo.id}"/>
    </div>
  </div>
...
<div class="container">
	...
	<tr>
		...
		<td>
		<a href="<c:url value="/admin/updateCategory/${category.id}"/>">Update</a>/
		<a href="<c:url value="/admin/deleteCategory/${category.id}"/>">Delete</a>
		</td>
	</tr>
	</c:forEach>
