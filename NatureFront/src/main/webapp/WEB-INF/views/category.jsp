...
<div class="container">
    <!-- <form class="form-inline" action="/admin/InsertCategory" method="post"> -->
    <c:url value="/admin/InsertCategory" var="url"></c:url>
...
<div class="container">
	...
	<c:forEach items="${listCategories}" var="category">
		<tr>
			...
			<td><a href="<c:url value="/admin/updateCategory/${category.id}"/>">Update</a>
